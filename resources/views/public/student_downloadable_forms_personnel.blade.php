...
<head>
    ...
    <title>Downloadable Forms for University Personnel - Polytechnic University of the Philippines</title>
...
<body>
    @php
        ...
        $pageData = $studentsCms['pages']['downloadable-forms-personnel'] ?? [];
    @endphp
    ...
    <main class="main-content students-review-page">
        @include('partials.student_linked_page', [
            'pageKey' => 'downloadable-forms-personnel',
            'pageData' => $pageData,
